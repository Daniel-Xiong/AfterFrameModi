...
const api = {
  ...
  similarityStatus: (...args) => invoke("similarityStatus", ...args),
  startSimilarityScan: (...args) => invoke("startSimilarityScan", ...args),
  listSimilarityGroups: (...args) => invoke("listSimilarityGroups", ...args),
  dismissSimilarityGroup: (...args) => invoke("dismissSimilarityGroup", ...args),
  confirmSimilarityGroup: (...args) => invoke("confirmSimilarityGroup", ...args),
  confirmRawSimilarity: (...args) => invoke("confirmRawSimilarity", ...args),
  relocateAssets: (...args) => invoke("relocateAssets", ...args),
  listRelocations: (...args) => invoke("listRelocations", ...args),
  ...
  setPeopleInferenceBackend: (...args) => invoke("setPeopleInferenceBackend", ...args),
  setPeopleRemoteConfig: (...args) => invoke("setPeopleRemoteConfig", ...args),
  testPeopleRemoteConnection: (...args) => invoke("testPeopleRemoteConnection", ...args),
