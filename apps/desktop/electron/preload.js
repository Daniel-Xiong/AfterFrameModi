...
contextBridge.exposeInMainWorld("mediaWorkspace", {
  ...
  getAssetDetailById: (assetId, options) => ipcRenderer.invoke("workspace:detail-by-id", assetId, options),
  listSimilarClusters: (options) => ipcRenderer.invoke("workspace:list-similar-clusters", options),
