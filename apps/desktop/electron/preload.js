...
contextBridge.exposeInMainWorld("mediaWorkspace", {
  ...
  deleteImageAssetsFromDisk: (items) => ipcRenderer.invoke("workspace:delete-image-assets-from-disk", { items }),
  similarityStatus: () => ipcRenderer.invoke("workspace:similarity-status"),
  startSimilarityScan: (options) => ipcRenderer.invoke("workspace:similarity-start", options),
  listSimilarityGroups: (options) => ipcRenderer.invoke("workspace:similarity-groups", options),
  ...
  setPeopleInferenceBackend: (backend) => ipcRenderer.invoke("workspace:set-people-inference-backend", backend),
  setPeopleRemoteConfig: (config) => ipcRenderer.invoke("workspace:set-people-remote-config", config),
  testPeopleRemoteConnection: (options) => ipcRenderer.invoke("workspace:test-people-remote-connection", options),
